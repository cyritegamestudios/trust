...
function load_user_files(main_job_id, sub_job_id)
	...
	player.trust.main_job:add_role(Reacter.new(action_queue, player.trust.main_job_settings.Default.GambitSettings, skillchainer))
	...
	if player.sub_job_name_short ~= 'NON' then
		player.trust.sub_job:add_role(Reacter.new(action_queue, player.trust.sub_job_settings.Default.GambitSettings, skillchainer))
