...
return {
    ...
    Default = {
        ...
        CureSettings = {
            Gambits = L{
                Gambit.new("Self", L{GambitCondition.new(ClusterHitPointsPercentRangeCondition.new(1, 60, 2), "Self")}, Spell.new("White Wind", L{}, L{}, nil, L{}), "Self", L{}, true),
                ...
                Gambit.new("Self", L{GambitCondition.new(HitPointsPercentRangeCondition.new(1, 60), "Self")}, Spell.new("Magic Fruit", L{}, L{}, nil, L{}), "Self", L{}, true),
                ...
                Gambit.new("Ally", L{GambitCondition.new(HitPointsPercentRangeCondition.new(1, 60), "Ally")}, Spell.new("Magic Fruit", L{}, L{}, nil, L{}), "Ally", L{}, true),
