...
return {
    ...
    Default = {
        CureSettings = {
            Gambits = L{
                Gambit.new("Self", L{GambitCondition.new(ClusterHitPointsPercentRangeCondition.new(1, 60, 2), "Self")}, JobAbility.new("Divine Waltz II"), "Self", L{}, true),
                ...
                Gambit.new("Self", L{GambitCondition.new(HitPointsPercentRangeCondition.new(1, 50), "Self")}, JobAbility.new("Curing Waltz V"), "Self", L{}, true),
                Gambit.new("Self", L{GambitCondition.new(HitPointsPercentRangeCondition.new(1, 60), "Self")}, JobAbility.new("Curing Waltz IV"), "Self", L{}, true),
                ...
                Gambit.new("Ally", L{GambitCondition.new(HitPointsPercentRangeCondition.new(1, 50), "Ally")}, JobAbility.new("Curing Waltz V"), "Ally", L{}, true),
                Gambit.new("Ally", L{GambitCondition.new(HitPointsPercentRangeCondition.new(1, 60), "Ally")}, JobAbility.new("Curing Waltz IV"), "Ally", L{}, true),
