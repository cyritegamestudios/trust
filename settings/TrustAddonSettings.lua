...
default.battle.targets = L{'Apex Knight Lugcrawler','Apex Rumble Lugcrawler','Locus Armet Beetle','Locus Colibri','Locus Dire Bat','Locus Ghost Crab','Apex Crab','Apex Toad'}
