...
return {
    ...
    Default = {
        ...
        GambitSettings = {
            Default = L{
                Gambit.new("Enemy", L{GambitCondition.new(ModeCondition.new("AutoTankMode", "Auto"), "Self"), GambitCondition.new(InBattleCondition.new(), "Self")}, JobAbility.new("Provoke", L{}), "Enemy", L{}),
            },
            Gambits = L{
