...
return {
    ...
    Default = {
        ...
        BuffSettings = {
            Gambits = L{
                Gambit.new("Self", L{GambitCondition.new(PartyHppRangeCondition.new(60, 100, 6, false), "Self")}, Buff.new("Haste", L{}, L{}, nil, L{}), "Self", L{"Buffs"}),
                Gambit.new("Self", L{GambitCondition.new(PartyHppRangeCondition.new(60, 100, 6, false), "Self")}, Buff.new("Reraise", L{}, L{}, nil, L{}), "Self", L{"Buffs"}),
                Gambit.new("Self", L{GambitCondition.new(PartyHppRangeCondition.new(60, 100, 6, false), "Self")}, JobAbility.new("Afflatus Solace", L{}, L{}), "Self", L{"Buffs"}),
                Gambit.new("Self", L{GambitCondition.new(PartyHppRangeCondition.new(60, 100, 6, false), "Self")}, Buff.new("Protectra", L{}, L{}, nil, L{}), "Self", L{"Buffs"}),
                Gambit.new("Self", L{GambitCondition.new(PartyHppRangeCondition.new(60, 100, 6, false), "Self")}, Buff.new("Shellra", L{}, L{}, nil, L{}), "Self", L{"Buffs"}),
                Gambit.new("Self", L{GambitCondition.new(PartyMemberCountCondition.new(3, ">=", 10), "Self"), GambitCondition.new(PartyHppRangeCondition.new(60, 100, 6, false), "Self")}, Spell.new("Boost-STR", L{}, L{}, nil, L{}), "Self", L{"Buffs"}, true),
                Gambit.new("Self", L{GambitCondition.new(MainJobCondition.new("WHM"), "Self"), GambitCondition.new(PartyMemberCountCondition.new(3, ">=", 10), "Self"), GambitCondition.new(PartyHppRangeCondition.new(60, 100, 6, false), "Self")}, Spell.new("Auspice", L{}, L{}, nil, L{}), "Self", L{"Buffs"}, true),
                Gambit.new("Ally", L{GambitCondition.new(JobCondition.new(L{"WAR", "WHM", "RDM", "PLD", "BRD", "SAM", "DRG", "BLU", "PUP", "SCH", "RUN", "MNK", "BLM", "THF", "BST", "RNG", "NIN", "SMN", "COR", "DNC", "GEO", "DRK"}), "Ally"), GambitCondition.new(PartyHppRangeCondition.new(60, 100, 6, false), "Self")}, Buff.new("Shell", L{}, L{}, nil, L{}), "Ally", L{"Buffs"}),
                Gambit.new("Ally", L{GambitCondition.new(JobCondition.new(L{"WAR", "WHM", "RDM", "PLD", "BRD", "SAM", "DRG", "BLU", "PUP", "SCH", "RUN", "MNK", "BLM", "THF", "BST", "RNG", "NIN", "SMN", "COR", "DNC", "GEO", "DRK"}), "Ally"), GambitCondition.new(PartyHppRangeCondition.new(60, 100, 6, false), "Self")}, Buff.new("Protect", L{}, L{}, nil, L{}), "Ally", L{"Buffs"})
            }
        },
        ...
        CureSettings = {
            Gambits = L{
                Gambit.new("Self", L{GambitCondition.new(ClusterHitPointsPercentRangeCondition.new(1, 65, 2), "Self")}, Spell.new("Curaga IV", L{}, L{}, nil, L{}), "Self", L{}, true),
                Gambit.new("Ally", L{GambitCondition.new(ClusterHitPointsPercentRangeCondition.new(1, 65, 2), "Ally")}, Spell.new("Curaga IV", L{}, L{}, nil, L{}), "Ally", L{}, true),
                Gambit.new("Self", L{GambitCondition.new(ClusterHitPointsPercentRangeCondition.new(1, 75, 2), "Self")}, Spell.new("Curaga III", L{}, L{}, nil, L{}), "Self", L{}, true),
                Gambit.new("Ally", L{GambitCondition.new(ClusterHitPointsPercentRangeCondition.new(1, 75, 2), "Ally")}, Spell.new("Curaga III", L{}, L{}, nil, L{}), "Ally", L{}, true),
