...
4. Double check that the `Windower/addons/follow` folder exists.
...
Trust requires the following libraries and addons:
* [Trust](https://github.com/cyritegamestudios/trust)
* [cylibs](https://github.com/cyritegamestudios/trust/tree/main/addons/libs/cylibs)
* Shortcuts
...
The second is Mode specific settings and can be found in the `Trust/data/modes` folder. You can use these to store values of Modes (e.g. `AutoBuffMode`, `AutoPullMode`, etc.) so you don't have to reset them every
...
| Command                        | Action                                                                                                                                                               |
|--------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| // trust load                  | Loads a configuration of Modes values for the current job.                                                                                                           |
