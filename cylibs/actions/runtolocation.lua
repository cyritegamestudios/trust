...
function RunToLocationAction:perform()
	...
	-- Kick off movement synchronously so action handovers don't leave a 1-frame gap
	-- between the previous action's run(false) and the next action's first run(dx, dy, z).
