...
function player_util.get_current_strategem_count()
	...
	local maxStrategems = (windower.ffxi.get_player().main_job_level + 10) / 20
...
-- NOTE: (scretella) this currently causes all of the items data to constantly be in memory which
